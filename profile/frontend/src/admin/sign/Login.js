  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="p-6 w-96 border rounded shadow-lg">
        <h1 className="text-2xl font-bold mb-4">Halaman Login</h1>
        {errorMessage && (
        ...
        <button
          className="bg-indigo-500 text-white font-bold py-2 px-4 rounded-lg w-full mb-4"
          onClick={handleLogin}
        >
          Masuk
        </button>
        <Link to={"/register"}>
          <button className="bg-green-500 text-white font-bold py-2 px-4 rounded-lg w-full">
            Halaman Daftar
          </button>
        </Link>
      </div>
